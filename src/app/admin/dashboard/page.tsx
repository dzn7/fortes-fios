...
const COLUNAS_PEDIDO_DASHBOARD =
  'id, nome_cliente, telefone, endereco, bairro, tipo_entrega, status, subtotal, taxa_entrega, taxa_servico, total, created_at, mesa, comanda, forma_pagamento, pagamento_online, pagamento_online_status, garcom_id, presente, cupom_id, cupom_codigo, desconto_cupom'
