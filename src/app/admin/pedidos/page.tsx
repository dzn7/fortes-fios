  ...
  const carregarPedidos = useCallback(async (silencioso = false) => {
    ...
    try {
      ...
      let query = supabase
        .from('pedidos')
        .select(
          'id, nome_cliente, telefone, endereco, bairro, tipo_entrega, status, subtotal, taxa_entrega, taxa_servico, total, created_at, forma_pagamento, pagamento_online, pagamento_online_status',
          { count: 'exact' },
        )
